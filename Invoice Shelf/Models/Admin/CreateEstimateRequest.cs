...
/// <summary>
/// Ligne d'article envoyée dans le payload de création de devis.
...
/// "Undefined array key". De plus, la colonne estimate_items.discount_type
...
/// n'envoyant pas "currency_id", EstimatesRequest::getEstimatePayload
/// compare currency_id (absent → null) à la devise de la société ; comme
/// elles diffèrent presque toujours, le serveur retient $this->exchange_rate
/// tel quel. Sans ce champ, exchange_rate est stocké à null en base, ce qui
/// fait échouer la désérialisation côté mobile (EstimateResource renvoie
